...
function listCards(){
	...
	$.ajax({
		url: 'control/metodo/selectCards.php',
		dataType:'json',
		data: {'date':date},
		beforeSend: function(){
...
function listStudyField(){
	$.ajax({
		url:'control/metodo/listStudyField.php',
...
function addStudyField(study_field){
	$.ajax({
		url:'control/metodo/addStudyField.php',
...
function changeStudyField(study_field,id){
	$.ajax({
		url:'control/metodo/changeStudyField.php',
...
function addReviewCicle(cicle){
	$.ajax({
		url:'control/metodo/addReviewCicle.php',
...
function listReviewCicle(){
	$.ajax({
		url:'control/metodo/listReviewCicle.php',
		success: function(response){
...
function listStudyFieldToModal(){
	$.ajax({
		url:'control/metodo/listStudyFieldToModal.php',
		success:function(data){
...
$(document).ready(function(){
		...
		/*btn add set*/ 
			$(document).on('click','#btn-add-set',function(){
				...
				if(!$.trim($('#input-title-review').val())){
					...
					$.ajax({
						url: 'control/metodo/addReview.php',
						method: 'POST',
	...
	/* MODAL */
		...
		$(document).on('click','#archive-card',function(){
			...
			$.ajax({
				url: 'control/metodo/archiveCard.php',
				data: {'id':id},
				success:function(data){
				},
				complete:function(){
		...
		$(document).on('click','#save-description',function(){
			...
			$.ajax({
				url: 'control/metodo/updateDescription.php',
	...
	/* CARDS */
		...
		$(document).on('click','#unchecker',function(e){
			...
			var date_review = data_review[array_position]['date_review'];
	 		$.ajax({
				url:'control/metodo/scheduleNextReview.php',
				method:'POST',
